...
formula names, carried through the parameter's own link and widened,
since a term cannot know whether a parameter is measured in the units of
the response or of a covariate and the box has to cover both.
