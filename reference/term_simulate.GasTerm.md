...
- score, curvature:
  ...
  Functions of `(y, e)` giving the derivatives of the log-density in the
  predictor. They take the response as an argument, unlike the filter's
  own, because here it is being made.
