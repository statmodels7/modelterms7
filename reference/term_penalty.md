...
penalizes the changes and not the linear effect or the break-points,
[`nl`](https://statmodels7.github.io/modelterms7/reference/nl.md)
penalizes one nonlinear parameter at a time, and
[`gas`](https://statmodels7.github.io/modelterms7/reference/gas.md)
penalizes the deviations of a panel. Reading a partial penalty here
would say that it covers the block, so the question this generic asks is
